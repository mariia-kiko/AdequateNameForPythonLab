...
def background (x, y, color1 = LIGHT_OLIVE, color2 = BLUE, color3 = YELLOW):
    '''
        ...
        color1, color2, color3 - background colors in RGB
    '''
...
def umbrella(x0, y0, hat_width, hat_height, stick_width, stick_height, n, hat_color = LIGHT_RED, stick_color = BROWN):
    '''
       ...
       hat_color, stick_color - colors in RGB
    '''
    ...
    polygon(surf, hat_color, [(0, hat_height), (0.5*hat_width, 0),
...
def boat (x0, y0, bottom_width, boat_height, stick_width, stick_height, boat_color = BROWN, sail_color = WHITE):
    '''
        ...
        boat_color, sail_color - colors in RGB
    '''
    ...
    polygon(surf, boat_color, [(bottom_width + boat_height, stick_height), (1.5*bottom_width + boat_height, stick_height),
    ...
    polygon(surf, sail_color, [(0.5*bottom_width + boat_height + stick_width, 0), (bottom_width + boat_height + stick_width, 0.4*stick_height),
                               (0.7*bottom_width + boat_height + stick_width, 0.4*stick_height)])
    polygon(surf, sail_color, [(0.5*bottom_width + boat_height + stick_width, 0.8*stick_height), (bottom_width + boat_height + stick_width, 0.4*stick_height),
                               (0.7*bottom_width + boat_height + stick_width, 0.4*stick_height)])
    line(surf, BLACK, (0.5*bottom_width + boat_height + stick_width, 0), (bottom_width + boat_height + stick_width, 0.4*stick_height))      
    line(surf, BLACK, (0.5*bottom_width + boat_height + stick_width, 0.8*stick_height), (bottom_width + boat_height + stick_width, 0.4*stick_height))
    line(surf, BLACK, (bottom_width + boat_height + stick_width, 0.4*stick_height),
                               (0.7*bottom_width + boat_height + stick_width, 0.4*stick_height))
    line(surf, BLACK, (0.7*bottom_width + boat_height + stick_width, 0.4*stick_height), (0.5*bottom_width + boat_height + stick_width, 0.8*stick_height))
    line(surf, BLACK, (0.7*bottom_width + boat_height + stick_width, 0.4*stick_height), (0.5*bottom_width + boat_height + stick_width, 0))
